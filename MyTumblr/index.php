...
$acc_username = "RyanNatividad";
$acc_password = "@ryan3024";
$acc_fullname = "Ryan M. Natividad";
...
if(isset($_REQUEST['login_button']) === true){
   ...
   elseif ($_REQUEST['form_username'] == $acc_username && $_REQUEST['form_pass'] != $acc_password) {
		...
		<div class="container">
			<div class="row justify-content-center">
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
		      			...
		      			elseif (isset($_SESSION['ses_username']) === true){
		      				echo "<div class='alert alert-warning'role='alert'> You are still logged in. Please <a href='account.php'> click here to </a> proceed... </div>";
	            ...
	            <div class="form-group d-flex">
	              <input type="password" class="form-control rounded-left" placeholder="Password" name="form_pass" required>
	            </div>
